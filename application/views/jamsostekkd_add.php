<div class="main-panel">
        <div class="content-wrapper">
            <div class="card">
                ...
                <hr>
                <?php echo form_open('cjamsostekkd/create');?>
                <div class="container">
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <input class="btn btn-primary" type="submit" value="Save">&nbsp;<a href="<?=base_URL()?>cjamsostekkd" class="btn btn-default text-muted">Cancel</a>
                        </div>
                    </div>
                </div>
                <?php echo form_close(); ?>
