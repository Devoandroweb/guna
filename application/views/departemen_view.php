                ...
                <div class="card-body">
                  <div class="row mb-2">
                      ...
                      <div class="col text-right">
                        <a href="<?= base_url() ?>cdepartemen/tambah" class="btn btn-primary ">
                    ...
                    <div class="table-responsive">
                      ...
                      <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            //     "iDisplayLength": 25,
                            //     "sAjaxSource": "<?php echo site_url('cdepartemen/list_departemen')?>",
                            //     "sServerMethod": "POST",
                            //     lengthChange: true,
                            ...
                            //         window.location.href = "cdepartemen/tambah";
                            //         },
                            ...
                            //     scrollCollapse: true
                            //     });
                            //     $("div.toolbar").html('<div class="text-center"><strong>Content Departemen</strong></div>');
