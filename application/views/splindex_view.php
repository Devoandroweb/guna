  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#ta').DataTable({
            ...
            "iDisplayLength": 25,
            "sAjaxSource": "<?php echo site_url('csplindex/list_splindex')?>",
            "sServerMethod": "POST",
            lengthChange: true,
            ...
            buttons: [
                {
                    ...
                    window.location.href = "csplindex/tambah";
                    },
            ...
            $("div.toolbar").html('<div class="text-center"><strong>Transaksi Surat Perintah Lembur Index</strong></div>');
