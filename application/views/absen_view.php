<div class="main-panel">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cabsen/tambah" class="btn btn-primary mr-1">
                            <i class="fa fa-plus"></i> 
                            Tambah
                          </a>
                          <a href="<?= base_url() ?>cabsen/upload" class="btn btn-secondary mr-1">
                            <i class="fa fa-upload"></i> 
                            Upload
                          </a>
                          <a href="<?= base_url() ?>cabsen/transact" class="btn btn-danger mr-1">
                            <i class="fa fa-share"></i> 
                            Commit
                          </a>
                          <a href="<?= base_url() ?>cabsen/excel" class="btn btn-success mr-1">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        //     "iDisplayLength": 25,
        //     "sAjaxSource": "<?php echo site_url('cabsen/list_absen')?>",
        //     "sServerMethod": "POST",
        //     lengthChange: true,
        ...
        //             window.location.href = "cabsen/upload";
        //             },
        ...
        //         {
        //             action: function (e, dt, node, config) {
        //             window.location.href = "cabsen/tambah";
        //             },
        ...
        //             action: function (e, dt, node, config) {
        //                 window.location.href = "cabsen/transact";
        //             }
        //         }
        //     ],
