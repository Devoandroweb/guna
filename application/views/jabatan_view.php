        ...
        <div class="content-wrapper">
                ...
                <div class="card-body">
                  <div class="row mb-2">
                        ...
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cjabatan/tambah" class="btn btn-primary ">
          ...
          <script type="text/javascript">
            $(document).ready(function() {
                ...
                //     "iDisplayLength": 25,
                //     "sAjaxSource": "<?php echo site_url('cjabatan/list_jabatan')?>",
                //     "sServerMethod": "POST",
                //     lengthChange: true,
                ...
                //         window.location.href = "cjabatan/tambah";
                //         },
                ...
                //     scrollCollapse: true
                //     });
                //     $("div.toolbar").html('<div class="text-center"><strong>Content Jabatan</strong></div>');
