    ...
    <table id="ta" class="stripe row-border order-column table-hover table table-condensed table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>Act</th>
                <th>id</th>
                <th>nilai_insentive_kehadiran</th>
                <th>lastupdate</th>
                <th>user_id</th>
            </tr>
        </thead>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#ta').DataTable({
            ...
            "iDisplayLength": 25,
            "sAjaxSource": "<?php echo site_url('cabsensi/list_insentive_kehadiran')?>",
            "sServerMethod": "POST",
            lengthChange: true,
            ...
            $("div.toolbar").html('<div class="text-center"><strong>Content Insentive Kehadiran</strong></div>');
