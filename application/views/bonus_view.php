        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-body">
                  <div class="row mb-2">
                        <div class="col">
                          <h4 class="card-title">Transaksi THR</h4>
                        </div>
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cbonus/excel" class="btn btn-success ">
                    ...
                    <div class="table-responsive">
                      ...
                      <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            //     "iDisplayLength": 25,
                            //     "sAjaxSource": "<?php echo site_url('cbonus/list_bonus')?>",
                            //     "sServerMethod": "POST",
                            //     lengthChange: true,
                            ...
                            //     }
                            // });
                            // $("div.toolbar").html('<div class="text-center"><strong>Transaksi THR</strong></div>');
