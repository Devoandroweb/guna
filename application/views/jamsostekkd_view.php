<div class="main-panel">
        <div class="content-wrapper">
            <div class="card">
                <div class="card-body">
                  <div class="row mb-2">
                        <div class="col">
                          <h4 class="card-title">Master Jamsostek Komponen Dasar</h4>
                        </div>
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cjamsostekkd/tambah" class="btn btn-primary ">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        //     "iDisplayLength": 25,
        //     "sAjaxSource": "<?php echo site_url('cjamsostekkd/list_jamsostekkd')?>",
        //     "sServerMethod": "POST",
        //     lengthChange: true,
        ...
        //         window.location.href = "cjamsostekkd/tambah";
        //         },
        ...
        //     scrollCollapse: true
        //     });
        //     $("div.toolbar").html('<div class="text-center"><strong>Master Jamsostek Komponen Dasar</strong></div>');
