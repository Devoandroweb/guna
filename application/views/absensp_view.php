  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#ta').DataTable({
            ...
            "iDisplayLength": 25,
            "sAjaxSource": "<?php echo site_url('cabsensp/list_absensp')?>",
            "sServerMethod": "POST",
            lengthChange: true,
            ...
            buttons: [
                ...
                window.location.href = "cabsensp/tambah";
                },
            ...
            $("div.toolbar").html('<div class="text-center"><strong>Master Absen Shift Pola</strong></div>');
