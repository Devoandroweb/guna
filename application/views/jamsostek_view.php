<div class="main-panel">
        <div class="content-wrapper">
            <div class="card">
                <div class="card-body">
                  <div class="row mb-2">
                        <div class="col">
                          <h4 class="card-title">Jam Samsostek</h4>
                        </div>
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cjamsostek/tambah" class="btn btn-primary ">
                        ...
                        <table id="t" class="table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <!-- <th>Maksimal Dasar</th>
                                    <th>Kode Gaji Potongan</th>
                                    <th>Last Update</th>
                                    <th>User ID</th> -->
                                </tr>
                            </thead>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        //     "iDisplayLength": 25,
        //     "sAjaxSource": "<?php echo site_url('cjamsostek/list_jamsostek')?>",
        //     "sServerMethod": "POST",
        //     lengthChange: true,
        ...
        //         window.location.href = "cjamsostek/tambah";
        //         },
        ...
        //     scrollCollapse: true
        //     });
        //     $("div.toolbar").html('<div class="text-center"><strong>Master Jamsostek</strong></div>');
