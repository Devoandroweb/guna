<div class="main-panel">
        <div class="content-wrapper">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col">
                          <h4 class="card-title">Transaksi Periode Jamsostek</h4>
                        </div>
                        <div class="col text-right button">
                          <a href="<?= base_url() ?>cperiodej/excel" class="btn btn-success mr-1"> <i class="fa  fa-file-excel-o"></i> Export</a>
                        </div>
                      </div>
                      <hr>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        //     "iDisplayLength": 25,
        //     "sAjaxSource": "<?php echo site_url('cperiodej/list_periodej')?>",
        //     "sServerMethod": "POST",
        //     lengthChange: true,
        ...
        //     }
        //     });
        //     $("div.toolbar").html('<div class="text-center"><strong>Transaksi Periode Jamsostek</strong></div>');
