    ...
    <?php echo form_open('csplindex/create');?>
    <p>&nbsp;</p><br /><br />
    <div class="container">
            <div class="rows col-md-11 wells btn-info">
                <div class="rows">
                    <div class="col-xs-12 col-sm-6 col-md-8"><strong>Surat Perintah Lembur Information - Index</strong></div>
                    <div class="col-xs-6 col-md-4" align="right">
                        <input class="btn-lgs btn btn-default" type="submit" value="Save">&nbsp;<a href="<?=base_URL()?>cspl" class="btn-lgs btn btn-default">Cancel</a></div>
                </div>
            </div>
        ...
        <div class="rows col-md-11 wells">
            <div class="row">
                ...
                <div class="rows col-md-3 wellsy btn-sm">
                    <div class="form-group">
                        <label for="jumlah_jam">Jumlah Jam Lembur - Index</label>
