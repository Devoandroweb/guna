        ...
        <div class="container">
            <div class="rows col-md-11 wells btn-info">
                <div class="rows">
                    <div class="col-xs-12 col-sm-6 col-md-8"><strong>Gaji Karyawan</strong></div>
                </div>
            </div>
                    ...
                    <div class="rows col-md-8 btn-sm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <label for="x" class="col-sm-8 control-label">Master Absen</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <form method="post" action="<?php echo base_url() ?>cgajikaryawan/importcsv" enctype="multipart/form-data">
