        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-body">
                  <div class="row mb-2">
                      <div class="col">
                        <h4 class="card-title">Master PPH-21 Tarif</h4>
                      </div>
                      <div class="col text-right">
                        <a href="<?= base_url() ?>cppht/tambah" class="btn btn-primary ">
                    ...
                    <div class="table-responsive">
                      ...
                      <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            //     "iDisplayLength": 25,
                            //     "sAjaxSource": "<?php echo site_url('cppht/list_ppht')?>",
                            //     "sServerMethod": "POST",
                            //     lengthChange: true,
                            ...
                            //         window.location.href = "cppht/tambah";
                            //         },
