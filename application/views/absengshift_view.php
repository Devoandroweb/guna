    ...
    <table id="ta" class="stripe row-border order-column table-hover table table-condensed table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th>masuk</th>
                <th>pulang</th>
                <th>kode_hari_masuk</th>
                <th>kode_hari_pulang</th>
                <th>lastupdate</th>
                <th>user_id</th>
            </tr>
        </thead>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#ta').DataTable({
            ...
            "iDisplayLength": 25,
            "sAjaxSource": "<?php echo site_url('cabsengshift/list_absengshift')?>",
            "sServerMethod": "POST",
            lengthChange: true,
            ...
            buttons: [
                ...
                window.location.href = "cabsengshift/tambah";
                },
            ...
            $("div.toolbar").html('<div class="text-center"><strong>Master Absen Grup Shift</strong></div>');
