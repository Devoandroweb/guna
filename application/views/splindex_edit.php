            ...
            <div class="rows col-md-11 wells btn-info">
                <div class="rows">
                    ...
                    <div class="col-xs-6 col-md-4" align="right">
                        ...
                        <a href="<?=base_URL()?>cspl" class="btn-lgs btn btn-default">Cancel</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="rows col-md-3 wellsy btn-sm">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo $row->nik;?>" type="search" name="nik" required="required" class="autocomplete form-control col-md-4 input-smm" id="autocomplete" placeholder="NIK" />
                    </div>
                    <div class="form-group">
