                ...
                <div class="card-body">
                  <div class="row mb-2">
                        ...
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cstatusperkawinan/tambah" class="btn btn-primary ">
                    ...
                    <div class="table-responsive">
                      ...
                      <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            //     "iDisplayLength": 25,
                            //     "sAjaxSource": "<?php echo site_url('cstatusperkawinan/list_statusperkawinan')?>",
                            //     "sServerMethod": "POST",
                            //     lengthChange: true,
                            ...
                            //         window.location.href = "cstatusperkawinan/tambah";
                            //         },
                            ...
                            //     scrollCollapse: true
                            //     });
                            //     $("div.toolbar").html('<div class="text-center"><strong>Content Status Perkawinan</strong></div>');
