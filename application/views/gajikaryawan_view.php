            ...
            <div class="card-body">
                <div class="row mb-2">
                        ...
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cgajikaryawan/tambah" class="btn btn-primary ">
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        //     "iDisplayLength": 25,
                        //     "sAjaxSource": "<?php echo site_url('cgajikaryawan/list_gajikaryawan')?>",
                        //     "sServerMethod": "POST",
                        //     lengthChange: true,
                        ...
                        //             window.location.href = "cgajikaryawan/tambah";
                        //         },
                        ...
                        //     }
                        // });
                        // $("div.toolbar").html('<div class="text-center"><strong>Master Gaji Karyawan</strong></div>');
