  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#ta').DataTable({
            ...
            "iDisplayLength": 25,
            "sAjaxSource": "<?php echo site_url('cpphm/list_pphm')?>",
            "sServerMethod": "POST",
            lengthChange: true,
            ...
            buttons: [
                {
                    ...
                    window.location.href = "cpphm/tambah";
                    },
            ...
            $("div.toolbar").html('<div class="text-center"><strong>Master PPH-21 Metode</strong></div>');
