  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#ta').DataTable({
            ...
            "iDisplayLength": 25,
            "sAjaxSource": "<?php echo site_url('cabsenjg/list_absenjg')?>",
            "sServerMethod": "POST",
            lengthChange: true,
            ...
            buttons: [
                ...
                window.location.href = "cabsenjg/tambah";
                },
            ...
            $("div.toolbar").html('<div class="text-center"><strong>Master Absen Jadwal Grup</strong></div>');
