                ...
                <div class="card-body">
                  ...
                  <div class="row mb-2">
                        ...
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cstatuskaryawan/tambah" class="btn btn-primary ">
                    ...
                    <div class="table-responsive">
                      ...
                      <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            //     "iDisplayLength": 25,
                            //     "sAjaxSource": "<?php echo site_url('cstatuskaryawan/list_statuskaryawan')?>",
                            //     "sServerMethod": "POST",
                            //     lengthChange: true,
                            ...
                            //         window.location.href = "cstatuskaryawan/tambah";
                            //         },
                            ...
                            //     scrollCollapse: true
                            //     });
                            //     $("div.toolbar").html('<div class="text-center"><strong>Content Status Karyawan</strong></div>');
