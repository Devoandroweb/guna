                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cgrup/tambah" class="btn btn-primary ">
                        ...
                        <div class="table-responsive">
                          ...
                          <script type="text/javascript">
                            $(document).ready(function() {
                                ...
                                //     "iDisplayLength": 25,
                                //     "sAjaxSource": "<?php echo site_url('cgrup/list_grup')?>",
                                //     "sServerMethod": "POST",
                                //     lengthChange: true,
                                ...
                                //         window.location.href = "cgrup/tambah";
                                //         },
                                ...
                                //     scrollCollapse: true
                                //     });
                                //     $("div.toolbar").html('<div class="text-center"><strong>Content Grup</strong></div>');
