        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-body">
                  <div class="row mb-2">
                        <div class="col">
                          <h4 class="card-title">Komponen Gaji Periode</h4>
                        </div>
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cperiodepenggajiank/tambah" class="btn btn-primary ">
                    ...
                    <div class="table-responsive">
                      ...
                      <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            //     "iDisplayLength": 25,
                            //     "sAjaxSource": "<?php echo site_url('cperiodepenggajiank/list_periodepenggajiank')?>",
                            //     "sServerMethod": "POST",
                            //     lengthChange: true,
                            ...
                            //         window.location.href = "cperiodepenggajiank/tambah";
                            //         },
                            ...
                            //     scrollCollapse: true
                            //     });
                            //     $("div.toolbar").html('<div class="text-center"><strong>Content Komponen Gaji Periode</strong></div>');
