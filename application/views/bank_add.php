                ...
                <div class="container">
                        <!-- <div class="rows col-md-11 wells btn-info">
                            <div class="rows">
                                ...
                                <div class="col-xs-6 col-md-4" align="right">
                                    <input class="btn-lgs btn btn-default" type="submit" value="Save">&nbsp;<a href="<?=base_URL()?>cbank" class="btn-lgs btn btn-default">Cancel</a></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <a href="<?=base_URL()?>cbank" class="btn btn-default text-muted">Cancel</a></div>
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
