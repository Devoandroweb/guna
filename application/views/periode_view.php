...
<div class="main-panel">
                ...
                <div class="card-body">
                  <div class="row mb-2">
                        ...
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cperiode/tambah" class="btn btn-primary ">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        //     "iDisplayLength": 25,
        //     "sAjaxSource": "<?php echo site_url('cperiode/list_periode')?>",
        //     "sServerMethod": "POST",
        //     lengthChange: true,
        ...
        //         window.location.href = "cperiode/tambah";
        //         },
        ...
        //     }
        //     });
        //     $("div.toolbar").html('<div class="text-center"><strong>Periode Penggajian</strong></div>');
