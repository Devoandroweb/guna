            ...
            <div class="card-body">
              <div class="row mb-2">
                  ...
                  <div class="col text-right">
                    <a href="<?= base_url() ?>ctunjangananak/tambah" class="btn btn-primary ">
                        ...
                        <table id="t" class="table" cellspacing="0" width="100%">
                          ...
                          <script type="text/javascript">
                            $(document).ready(function() {
                                ...
                                //     "iDisplayLength": 25,
                                //     "sAjaxSource": "<?php echo site_url('ctunjangananak/list_tunjangan_anak')?>",
                                //     "sServerMethod": "POST",
                                //     lengthChange: true,
                                ...
                                //         window.location.href = "ctunjangananak/tambah";
                                //         },
                                ...
                                //     scrollCollapse: true
                                //     });
                                //     $("div.toolbar").html('<div class="text-center"><strong>Master Tunjangan Anak</strong></div>');
