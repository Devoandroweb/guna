  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#ta').DataTable({
            ...
            "iDisplayLength": 25,
            "sAjaxSource": "<?php echo site_url('cperiodepenggajian/list_periodepenggajian')?>",
            "sServerMethod": "POST",
            lengthChange: true,
            ...
            buttons: [
                ...
                window.location.href = "cperiodepenggajian/tambah";
                },
            ...
            $("div.toolbar").html('<div class="text-center"><strong>Content Periode Penggajian</strong></div>');
