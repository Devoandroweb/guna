<div class="main-panel">
                ...
                <div class="card-body">
                  <div class="row mb-2">
                        ...
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cgaji/tambah" class="btn btn-primary ">
                    ...
                    <div class="table-responsive">
                      <table id="t" class="table table-gaji" cellspacing="0" width="100%">
                          <thead>
                              <tr>
                                  <th>Opsi</th>
                                  <th>Kode Gaji</th>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        //     "iDisplayLength": 25,
        //     "sAjaxSource": "<?php echo site_url('cgaji/list_gaji')?>",
        //     "sServerMethod": "POST",
        //     lengthChange: true,
        ...
        //         window.location.href = "cgaji/tambah";
        //         },
        ...
        //     }
        //     });
        //     $("div.toolbar").html('<div class="text-center"><strong>Master Gaji</strong></div>');
        ...
        (function($) {
          ...
          $(function() {
            ...
            $('#t').each(function() {
              ...
              // $(".table-gaji tr td").css("line-height","20px");
              // datatable.closest('.dataTables_wrapper tr td').css("line-height","200px");
            });
          });
        })(jQuery);
