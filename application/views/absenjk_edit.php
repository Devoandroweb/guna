    ...
    <div class="container">
            <div class="rows col-md-11 wells btn-info">
                <div class="rows">
                    <div class="col-xs-12 col-sm-6 col-md-8"><strong>Grup Shift Information</strong></div>
                    <div class="col-xs-6 col-md-4" align="right"><input class="btn-lgs btn btn-default" type="submit" value="Save">&nbsp;<a href="<?=base_URL()?>cgshift" class="btn-lgs btn btn-default">Cancel</a></div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="rows col-md-3 wellsy btn-sm">
                    <div class="form-group">
                        ...
                        <input value="<?php echo $row->jenis;?>" disabled="disabled" type="text" class="form-control col-md-4 input-smm" id="jenis" placeholder="Jenis" />
                        <input name="jenis" value="<?php echo $row->jenis;?>" type="hidden" class="form-control col-md-4 input-smm" id="jenis" placeholder="Jenis" />
                    </div>
                    <div class="form-group">
