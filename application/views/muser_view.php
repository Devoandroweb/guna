...
<div class="main-panel">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cmuser/tambah" class="btn btn-primary ">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        //     "iDisplayLength": 25,
        //     "sAjaxSource": "<?php echo site_url('cmuser/list_muser')?>",
        //     "sServerMethod": "POST",
        //     lengthChange: true,
        ...
        //             window.location.href = "cmuser/tambah";
        //             },
        ...
        //     paging:         true
        //     });
        //     $("div.toolbar").html('<div class="text-center"><strong>User</strong></div>');
