        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col">
                          <h4 class="card-title">Master Grup Shift</h4>
                        </div>
                        <div class="col text-right">
                          <a href="<?= base_url() ?>cgshift/tambah" class="btn btn-primary ">
                    ...
                    <div class="table-responsive">
                        <table id="t" class="table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <!-- <th>Masuk</th>
                                    <th>Pulang</th>
                                    <th>Kode Hari Masuk</th>
                                    <th>Kode Hari Pulang</th>
                                    <th>Masuk Valid Awal</th>
                                    <th>Masuk Valid Akhir</th> -->
                                    <th>Lastupdate</th>
                                    <th>User ID</th>
                                </tr>
                            </thead>
                      ...
                      <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            //     "iDisplayLength": 25,
                            //     "sAjaxSource": "<?php echo site_url('cgshift/list_gshift')?>",
                            //     "sServerMethod": "POST",
                            //     lengthChange: true,
                            ...
                            //         window.location.href = "cgshift/tambah";
                            //         },
                            ...
                            //     scrollCollapse: true
                            //     });
                            //     $("div.toolbar").html('<div class="text-center"><strong>Master Grup Shift</strong></div>');
