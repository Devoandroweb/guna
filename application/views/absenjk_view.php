  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#ta').DataTable({
            ...
            "iDisplayLength": 25,
            "sAjaxSource": "<?php echo site_url('cabsenjk/list_absenjk')?>",
            "sServerMethod": "POST",
            lengthChange: true,
            ...
            buttons: [
                ...
                window.location.href = "cabsenjk/tambah";
                },
            ...
            $("div.toolbar").html('<div class="text-center"><strong>Master Absen Jadwal Karyawan</strong></div>');
