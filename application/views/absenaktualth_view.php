  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#ta').DataTable({
            ...
            "iDisplayLength": 25,
            "sAjaxSource": "<?php echo site_url('cabsenaktualth/list_absenaktualth')?>",
            "sServerMethod": "POST",
            lengthChange: true,

            dom: '<"top">B<"toolbar">frt<"bottom">i<"clear">pl<"clear">',
            ...
            $("div.toolbar").html('<div class="text-center"><strong>Transaksi Absen - Tidak Hadir</strong></div>');
