$(function(){
    ...
    var base_url='http://localhost/payroll/'; // Here i define the base_url
    // Fullcalendar
    $('#calendar').fullCalendar({
        ...
        events: base_url+'cabsenhb/getEvents',
        // Handle Day Click
        ...
        eventDrop: function(event, delta, revertFunc) {  
               $.post(base_url+'cabsenhb/dragUpdateEvent',{                            
                id:event.id,
    ...
    $('.modal').on('click', '#add-event',  function(e){
        if(validator(['title'])) {
            $.post(base_url+'cabsenhb/addEvent', {
                title: $('#title').val(),
    ...
    $('.modal').on('click', '#update-event',  function(e){
        if(validator(['title'])) {
            $.post(base_url+'cabsenhb/updateEvent', {
                id: currentEvent._id,
                title: $('#title').val(),
    ...
    $('.modal').on('click', '#delete-event',  function(e){
        $.get(base_url+'cabsenhb/deleteEvent?id=' + currentEvent._id, function(result){
            $('.modal').modal('hide');
            $('#calendar').fullCalendar("refetchEvents");
        });
    });
